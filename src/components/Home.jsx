...
const Home = () => {
  return (
    <div name="home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800'>
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                <h2 className='text-2xl sm:text-5xl font-bold text-white pt-11 my-8 max-h-px max-w-md '>I'm a Front End Developer</h2>
                <p className='text-gray-500 pt-20 max-w-md '> 
    ...
    <div>
        <img src={heroImage} alt='my profile' className='rounded-2xl max-h-96 max-w-screen-md mx-6  mb-9 sm:ml-6 md:max-h-80 lg:max-h-96'/>
